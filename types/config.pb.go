...
type RelayerConfig struct {
	...
	SignViaHsm                bool          `protobuf:"varint,15,opt,name=signViaHsm,proto3" json:"signViaHsm,omitempty"`
	Secp256K1KeyIndex4Eth     int32         `protobuf:"varint,16,opt,name=secp256k1KeyIndex4Eth,proto3" json:"secp256k1KeyIndex4Eth,omitempty"`
	Secp256K1KeyIndex4Chain33 int32         `protobuf:"varint,17,opt,name=secp256k1KeyIndex4Chain33,proto3" json:"secp256k1KeyIndex4Chain33,omitempty"`
	Chain33PubKey             string        `protobuf:"bytes,18,opt,name=chain33PubKey,proto3" json:"chain33PubKey,omitempty"`
	EthereumValidator         string        `protobuf:"bytes,19,opt,name=ethereumValidator,proto3" json:"ethereumValidator,omitempty"`
}
...
func (x *RelayerConfig) GetSignViaHsm() bool {
	if x != nil {
		return x.SignViaHsm
	}
	return false
...
func (x *RelayerConfig) GetSecp256K1KeyIndex4Eth() int32 {
	if x != nil {
		return x.Secp256K1KeyIndex4Eth
	}
	return 0
}

func (x *RelayerConfig) GetSecp256K1KeyIndex4Chain33() int32 {
	if x != nil {
		return x.Secp256K1KeyIndex4Chain33
	}
	return 0
}

func (x *RelayerConfig) GetChain33PubKey() string {
	if x != nil {
		return x.Chain33PubKey
	}
	return ""
}

func (x *RelayerConfig) GetEthereumValidator() string {
	if x != nil {
...
var file_config_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0xba, 0x06, 0x0a, 0x0d, 0x52, 0x65, 0x6c, 0x61, 0x79, 0x65, 0x72,
	...
	,
