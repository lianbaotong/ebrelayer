...
import (
	...
	"github.com/lianbaotong/ebrelayer/relayer"
	chain33Relayer "github.com/lianbaotong/ebrelayer/relayer/chain33"
	ethRelayer "github.com/lianbaotong/ebrelayer/relayer/ethereum"
	"github.com/lianbaotong/ebrelayer/relayer/events"
	ebrelayerTypes "github.com/lianbaotong/ebrelayer/types"
...
func main() {
	...
	ethStartPara := &ethRelayer.EthereumStartPara{
		...
		EthBridgeClaimChan: ethBridgeClaimChan,
		Chain33MsgChan:     chain33MsgChan,
		Validator:          cfg.EthereumValidator,
		SignViaHsm:         cfg.SignViaHsm,
